...
export default function Product({ params }: { params: { categoryId: string; brandId: string } }) {
...
//__________________________________________________________________________________________________________________________
    ...
    const getProducts = () => {
        productCategoryService.getByCategory(params.categoryId)
          .then((response: any) => {
    ...
    return (
        <Layout>
            <Header style={{ display: 'flex', alignItems: 'center' }}>
                ...
                />
                <div className="logo" style={{ marginLeft: 'auto', marginRight: '24px' }}>
